...
def _convert_xml_element_to_dict(xml_element: Element):
...
def read_xml_file(file_path: str,
                  records_tag: str,
                  to_dict: Optional[bool] = False, **kwargs) -> Union[
    Iterator[Element], Iterator[XmlDictElement], Iterator[XmlListElement]]:
...
def read_xml_string(xml_string: str,
                    records_tag: str,
                    to_dict: Optional[bool] = False, **kwargs) -> Union[
    Iterator[Element], Iterator[XmlDictElement], Iterator[XmlListElement]]:
